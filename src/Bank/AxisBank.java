...
public class AxisBank extends AccountFunctionality {
    ...
    public AxisBank(String accountHolderName, int age, long adharNumber, long phonenumber, int minimumDeposite, String AccountNumber) {
    ...
    public void accountFuntionality(){
        String choiceAgain;
        do {
            System.out.println("--------Axis Bank  Account  Services-------");
    ...
    public void bankServices(){
        System.out.println("--------Welcome to Axis Bank Loan Services");
